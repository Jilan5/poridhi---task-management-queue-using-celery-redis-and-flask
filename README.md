...
4. Task details including:
   ...
   - Runtime
   - Result
![flower]([images/flower dashboard.png](https://github.com/Jilan5/poridhi---task-management-queue-using-celery-redis-and-flask/blob/main/images/flower%20dashboard.png?raw=true))
